...
interface HarvestSessionFiltersProps {
    activeStatus: string;
...
const HarvestSessionFilters: FC<HarvestSessionFiltersProps> = ({ activeStatus, onStatusChange, cropNames, activeCrop, onCropChange }) => (
    <>
...
export default HarvestSessionFilters;