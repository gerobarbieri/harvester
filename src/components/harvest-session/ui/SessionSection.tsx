    ...
    if (loading) {
        return (
            <div className="text-center py-8">
                <p className="text-text-secondary">Cargando lotes de cosecha...</p>
            </div>
        );
    }
        ...
        <div className="space-y-6">
            <div className="max-h-[60vh] overflow-y-auto pr-2 space-y-6">
                {harvestSessions.length > 0 ? (
                    ...
                    <div className="text-center py-8">
                        <p className="text-text-secondary">No se encontraron lotes de cosecha.</p>
                    </div>
                )}
            </div>
            ...
            {/* {harvestSessions.length > 0 && (
                <div className="flex justify-center">
                    <Button
                        ...
                        className="bg-gray-200 text-gray-800 hover:bg-gray-300 focus:ring-gray-400"
                    >
                        Cargar más Lotes
                    </Button>
                </div>
