...
import { MinusCircle, AlertTriangle, Archive, Lock, TrendingUp, TrendingDown } from 'lucide-react'; // Se añaden íconos
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        {isClosed ? (
                            <div className="mt-2 space-y-1.5">
                                {hasLoss && (
                                    <div className="text-xs font-semibold text-yellow-800 bg-yellow-100 inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full">
                                        <AlertTriangle size={12} />
                                        <span>{formatNumber(silo.lost_kg)} kg perdidos</span>
                                    </div>
                                )}
                                {hasDifference && (
