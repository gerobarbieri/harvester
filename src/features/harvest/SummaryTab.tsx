            ...
            {estimatedYield > 0 && (
                <Card className="p-6 h-full flex flex-col">
                    ...
                    <div className="flex flex-col items-center text-center py-4">
                        ...
                        <p className={`text-4xl font-bold tracking-tight ${percentageDeviation >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                            {percentageDeviation > 0 ? '+' : ''}{formatNumber(percentageDeviation, 1)}%
                        </p>
                        <p className={`mt-1 text-sm font-medium ${percentageDeviation >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                    ...
                    <div className="grid grid-cols-2 gap-4 text-center mt-auto">
                        <div className="flex flex-col items-center">
                            <Tractor className="w-6 h-6 text-green-600 mb-1" />
