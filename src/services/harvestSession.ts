import { doc, serverTimestamp, updateDoc, collection, addDoc, Timestamp } from "firebase/firestore";
import type { Campaign, CampaignField, Crop, Harvester, HarvestManager, HarvestSession, HarvestStatus, Plot, User } from "../types";
